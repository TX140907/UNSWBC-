...
public:
    ...
    Policy policy(bool confined) const {
        ...
        // BEGIN MAP TRAINING
        switch (mapPlan()) {
        case MapPlan::Arena: p.continuation=0.35; p.reserve=8; break;
        case MapPlan::Colosseum: p.continuation=0.35; p.reserve=8; break;
        case MapPlan::Default: p.expand=true; p.cautiousChild=true; p.splitLength=6; p.target=16; p.reserve=8; p.stop=260; break;
        case MapPlan::DefaultSmall: p.continuation=0.35; p.reserve=8; break;
        case MapPlan::Schooltime: p.continuation=0.35; p.reserve=8; break;
        case MapPlan::Trophy: p.expand=true; p.cautiousChild=true; p.splitLength=6; p.target=16; p.reserve=8; p.stop=260; break;
        default: break;
        }
        // END MAP TRAINING
        return p;
